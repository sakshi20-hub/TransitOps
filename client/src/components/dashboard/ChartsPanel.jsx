// Deliberately not pulling in a charting library for these - the data is simple
// enough that plain CSS bars keep the bundle light. Swap for recharts/visx later
// if the analytics views get more complex.
